		...
		<div class="mx-auto grid max-w-[59rem] flex-1 auto-rows-max gap-4">
			<div class="flex items-center gap-4">
				...
				<div class="hidden items-center gap-2 md:ml-auto md:flex">
					...
					<ButtonThemed size="sm">Save Recipe</ButtonThemed>
				</div>
			</div>
			<div class="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
				<div class="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
						...
						<Card.Content>
							<div class="grid gap-6">
								<div class="grid gap-3">
									...
									<Input id="name" type="text" class="w-full" placeholder="Chocolate cookies" />
								</div>
								<div class="grid gap-3">
					...
					<Card.Root>
						<Card.Header>
							...
							<Card.Description>Please select the tools needed to make this recipe</Card.Description
							>
						</Card.Header>
						<Card.Content>
				...
				<div class="grid auto-rows-max items-start gap-4 lg:gap-8">
					<Card.Root class="overflow-hidden">
						<Card.Header>
							<Card.Title>Recipe Images</Card.Title>
