...
export async function deleteRecipeImage(
	...
	// Example url: https://firebasestorage.googleapis.com/v0/b/madeinpierre-cuicuit.appspot.com/o/recipes%2Fx8GlJxkpILm91WflsPLz%2F42cbdf6b-7aec-4de9-a21b-e6f654379f57.png?alt=media&token=***REMOVED***
