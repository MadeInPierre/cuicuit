...
In addition to the above documentation, you have access to tools to assist you in answering questions about Svelte and SvelteKit. Use them as needed to get more specific information before responding to the user or implementing a feature.